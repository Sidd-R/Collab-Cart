...
export default function Toggle({contributeAll,setContributeAll}) {
  
  return (
    <Switch
      checked={contributeAll}
      onChange={setContributeAll}
    ...
    >
      ...
      <span
        ...
        className={classNames(
          contributeAll ? 'bg-blue-500' : 'bg-yellow-300',
      ...
      <span
        aria-hidden="true"
        className={classNames(
          contributeAll ? 'translate-x-5' : 'translate-x-0',
