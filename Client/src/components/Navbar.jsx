                  ...
                  <Tab.List className="-mb-px flex px-4 space-x-8">
                    {navigation.categories.map((category) => (
                      <Tab
                        ...
                        className={({ selected }) =>
                          classNames(
                            selected ? 'text-indigo-600 border-indigo-600' : 'text-white border-transparent',
                          ...
                          >
                            {section.items.map((item) => (
                              <li key={item.name} className="flow-root">
                                <a href={item.href} className="-m-2 p-2 block text-gray-200">
                                  {item.name}
                                </a>
                              </li>
                            ))}
            ...
            <div className="h-16 flex items-center">
                                          ...
                                          >
                                            {section.items.map((item) => (
                                              <li key={item.name} className="flex">
                                                <a href={item.href} className="hover:text-orange-200">
                                                  {item.name}
                                                </a>
                                              </li>
                                            ))}
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  <a href="#" className="text-sm font-medium text-white hover:text-orange-200">
                    Sign in
                  </a>
                ...
                <div className="ml-2 flow-root lg:ml-6">
                   <a href="/ShopCart" className="group -m-2 p-2 flex items-center">
                    <ShoppingBagIcon
